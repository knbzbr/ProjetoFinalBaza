...
namespace ProjetoFinalBaza.Controllers
{
    public class CidadeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CidadeNome,EstadoNome")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CidadeNome,EstadoNome")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
